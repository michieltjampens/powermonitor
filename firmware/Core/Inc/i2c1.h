...
#define ERROR_I2C_NO_BUSY_FLAG     0x16
#define ERROR_I2C_NO_TC_DETECT     0x17
#define ERROR_I2C_NO_BUSY_FLAG2    0x18
#define ERROR_I2C_NO_STOP_DT  	   0x19
#define ERROR_I2C_DATA_REC_DELAY   0x1A
#define ERROR_I2C_NO_TXE_EMTPY     0x1B
